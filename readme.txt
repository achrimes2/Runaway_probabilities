...
Inputs:
 - Choice (enter either 'Gaia DR3', 'HST', 'JWST', 'NGRST' or 'custom')
 - Distance [kpc]
 - Av
...
Where 'maglim' is the limiting magnitude and 'mu_min' is the minimum measurable proper motion. mu_min will be overriden by a magnitide dependent model, or 0.01 mas/yr for NGRST, if
anything other than choice='custom'. The 'years' parameter, the gap between observations, is included in the model if choice='HST' or 'JWST'.
